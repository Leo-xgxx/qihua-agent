...
设计全文：[docs/design.md](docs/design.md) ｜ 落地路线：[docs/roadmap.md](docs/roadmap.md) ｜ agent 铁律：[CLAUDE.md](CLAUDE.md) ｜ 运行手册：[docs/运行手册.md](docs/运行手册.md) ｜ 提示词优化版：[docs/提示词优化/](docs/提示词优化/README.md)
